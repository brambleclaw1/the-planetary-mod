				...
				PlacementUtils.register("the_planetary_mod:tree_allay_biome",
						FeatureUtils.register("the_planetary_mod:tree_allay_biome", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.AMETHYST_BLOCK.defaultBlockState()),
										new StraightTrunkPlacer(7, 2, 0), BlockStateProvider.simple(Blocks.DIAMOND_BLOCK.defaultBlockState()),
										new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
										.decorators(ImmutableList.of(AllayBiomeLeaveDecorator.INSTANCE, AllayBiomeTrunkDecorator.INSTANCE,
												AllayBiomeFruitDecorator.INSTANCE))
										.build()),
						List.of(CountPlacement.of(4), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING),
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("the_planetary_mod:grass_allay_biome", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("the_planetary_mod:flower_allay_biome", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
